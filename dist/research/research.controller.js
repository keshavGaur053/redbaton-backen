...
const update_research_dto_1 = require("./dto/update-research.dto");
let ResearchController = class ResearchController {
    constructor(researchService) {
        this.researchService = researchService;
    }
    create(createResearchDto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_research_dto_1.UpdateResearchDto]),
    __metadata("design:returntype", void 0)
